# CLAUDE.md — Plataforma de Apoyo Psicoeducativo

> Este archivo es leído por Claude Code (y extensiones compatibles como Antigravity) al inicio de cada sesión. Contiene todo el contexto necesario para continuar el desarrollo sin repetir instrucciones. **No modificar sin consenso del equipo.**
